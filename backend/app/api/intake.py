...
AGENTS = [
    ...
    },
    {
        ...
        "description": "Checks whether a Legal escalation package has all referenced attachments and business inputs.",
    },
    {
        "id": "risk_aggregator",
    ...
    *,
    ...
    payload = {
        ...
        "metrics": {
            ...
            "needs_business_input": legal_escalation_triggered and _needs_business_input(review_result),
            "contract_type": contract_type,
...
def _auto_route_agents(text: str, contract_type: str) -> list[str]:
    routed = ["contract_understanding", "contract_triage", "playbook_checker", "completeness_checker", "risk_aggregator"]
...
def _contract_history_status(is_final_version: bool, result: AgentResult, legal_qa_escalate: bool) -> str | None:
    ...
    if _non_completeness_findings(result) or legal_escalation_triggered:
