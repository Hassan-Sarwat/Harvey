...
const titles: Record<WorkspaceView, { title: string; sub: string }> = {
  review: { title: "Review Contract", sub: "Upload a DPA and let the AI counsel audit it" },
  qa: { title: "Legal Q&A", sub: "Ask the AI counsel anything about GDPR, BDSG or BMW playbook" },
  escalations: { title: "Escalations", sub: "Contracts flagged for human review with highlighted clauses" },
  dashboard: { title: "Dashboard", sub: "Insights across every audit you have run" },
};
